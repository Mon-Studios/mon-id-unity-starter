...
namespace Thirdweb.Unity.Examples
{
    ...
    public class PlaygroundManager : MonoBehaviour
    {
        ...
        [SerializeField]
        private string _authLoadPath;
        [SerializeField]
        private string _ecosystemId;
        [SerializeField]
        ...
        private async void ConnectWallet(WalletOptions options)
        {
            ...
            Debug.Log((wallet as SmartWallet).GetAddress());
        ...
        private void InitializeEcosystemWalletPanel_Phone()
        {
            ...
            panel.InputFieldSubmitButton.onClick.AddListener(() =>
            {
                try
                {
                    ...
                    var ecosystemWalletOptions = new EcosystemWalletOptions(ecosystemId: _ecosystemId, phoneNumber: phone, ecosystemPartnerId: _partnerId);
        ...
        private async void InitializeMonFunctionPanel()
        {
            ...
            async void GetAddress()
            {
                ...
                var moreAddress = await (currentWallet as SmartWallet).GetAddress();

                Debug.Log(moreAddress);
